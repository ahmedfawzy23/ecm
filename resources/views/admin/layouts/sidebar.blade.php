<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('admin.categories.create-category') }}">Category</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('admin.categories.create-sub-category') }}">SubCategory</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('admin.products.create-products') }}">
                <span class="menu-icon">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('admin.support-questions') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-lifebuoy"></i>
                </span>
                <span class="menu-title">Support Questions</span>
            </a>
        </li>
        <li class="nav-item menu-items">
